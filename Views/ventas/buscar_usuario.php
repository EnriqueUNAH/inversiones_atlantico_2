	...
	<section id="container">
		...
		<div class="containerTable">
			<table>
				...
				$sql_registe = mysqli_query($conection, "SELECT COUNT(*) as total_registro FROM tbl_ms_usuarios 
				...
				$query = mysqli_query($conection, "SELECT u.idusuario, u.nombre, u.correo, u.id_usuario, r.rol FROM tbl_ms_usuarios u INNER JOIN rol r ON u.rol = r.idrol 
										WHERE 
