...
if (!empty($_POST)) {
	...
	if (empty($_POST['nombre']) || empty($_POST['correo']) || empty($_POST['usuario'])  || empty($_POST['rol'])) {
		...
		$query = mysqli_query($conection, "SELECT * FROM tbl_ms_usuarios 
...
$sql = mysqli_query($conection, "SELECT u.idusuario, u.nombre,u.correo,u.id_usuario, (u.rol) as idrol, (r.rol) as rol
