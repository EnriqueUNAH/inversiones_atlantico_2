        ...
        <form id="formDescuento" name="formDescuento" class="form-horizontal">
          ...
          <div class="form-row">
            <div class="form-group col-md-7">
              <label for="txtdescuento">Nombre Descuento</label>
              <input type="text" pattern="[a-zA-Z0-9_]+" class="form-control" id="txtdescuento" name="txtdescuetno" style="text-transform:uppercase" required="" title="Ingrese solo letras y números sin espacios">
            </div>
          </div>
          <div class="form-row">
