            ...
            <form id="formPerfil" name="formPerfil" class="form-horizontal">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="txtusuario">Identificación <span class="required">*</span></label>
                  <input type="text" class="form-control" id="txtusuario" name="txtusuario" value="<?= $_SESSION['userData']['usuario']; ?>" required="">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
