	...
	<section id="container">
		...
		<div class="containerTable">
			<table>
				...
				<?php
				//Paginador
				$sql_registe = mysqli_query($conection, "SELECT COUNT(*) as total_registro FROM tbl_producto WHERE estado = 1 ");
				...
				$query = mysqli_query($conection, "SELECT p.cod_producto, p.nombre_producto, p.precio, p.existencia, pr.proveedor
											...
											WHERE p.estado = 1 ORDER BY p.cod_producto DESC LIMIT $desde,$por_pagina
				");
