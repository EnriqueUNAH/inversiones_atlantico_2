...
if (empty($_REQUEST['cl']) || empty($_REQUEST['f'])) {
	...
	if ($result > 0) {
		...
		//$logo = '/img/logo.png';
		$query_productos = mysqli_query($conection, "SELECT p.nombre_producto,dt.cantidad,dt.precio_venta,dt.cantidad_multi,dt.promocion,(dt.cantidad_multi * dt.precio_venta) as precio_total
														FROM tbl_factura f
