...
class VentasModel extends Mysql
{
	...
	public function selectVentas()
	{
		...
		$sql = "SELECT f.cod_factura,f.numero_factura,f.fecha,u.usuario,f.estado,f.totalfactura,f.subtotal,f.isv,f.porcentaje_isv,f.descuento,cl.nombres,cl.cod_cliente
