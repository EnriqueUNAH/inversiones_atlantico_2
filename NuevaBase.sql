...
>>>>>>> 5d930bd342bb9360df81c876aee4f7487d59bfb2
  ...
  KEY `DetallePromoTmp_CodProducto_codx` (`cod_producto`),
...
CREATE TABLE `tbl_cliente` (
  ...
  `apellcodos` varchar(100) DEFAULT NULL COMMENT 'Apellcodos del cliente.',
...
INSERT INTO `tbl_cliente` VALUES (5,NULL,'CONSUMcodOR FINAL','',NULL,'','',NULL,1,1,NULL,NULL,'ADMIN','2023-04-13 00:57:28'),(6,'801200002389','DORCA NINOSCA AGUILAR','A',97293000,'dorca@hotmail.com','LOS PINOS',NULL,NULL,1,'ADMIN','2023-04-11 21:21:35','ADMIN','2023-04-13 00:36:35'),(11,'0801000011112','ELIZABETH REYES',NULL,98237281,NULL,'TELA',NULL,1,1,NULL,NULL,NULL,NULL);
...
CREATE TABLE `tbl_compra` (
  ...
  KEY `Compra_codUsuario_codx` (`cod_usuario`),
  CONSTRAINT `Compra_codUsuario` FOREIGN KEY (`cod_usuario`) REFERENCES `tbl_ms_usuarios` (`cod_usuario`)
...
CREATE TABLE `tbl_configuracion_cai` (
  ...
  KEY `CAI_codUsuario_codx` (`cod_usuario`),
  CONSTRAINT `CAI_codUsuario` FOREIGN KEY (`cod_usuario`) REFERENCES `tbl_ms_usuarios` (`cod_usuario`)
...
CREATE TABLE `tbl_detalle_compra` (
  ...
  `cantcodad` int DEFAULT NULL COMMENT 'Cantcodad que se está comprando.',
  ...
  KEY `TBL_PRODUCTO_COD_PRODUCTO_codx` (`cod_producto`),
  KEY `TBL_COMPRA_COD_COMPRA_codx` (`cod_compra`),
...
CREATE TABLE `tbl_detalle_factura` (
  ...
  `cantcodad` int DEFAULT NULL COMMENT 'Cantcodad del producto que se está vendiendo.',
  `precio_venta` decimal(10,2) DEFAULT NULL COMMENT 'Precio de Venta.',
  `cantcodad_multi` int DEFAULT NULL COMMENT 'Esta es la cantcodad que se va a multiplicar con el precio.',
  ...
  PRIMARY KEY (`cod_detalle_factura`),
  KEY `DetalleFactura_CodProducto_codx` (`cod_producto`),
  KEY `DetalleFactura_NoFactura_codx` (`cod_factura`),
...
CREATE TABLE `tbl_detalle_produccion` (
  ...
  `cantcodad` int DEFAULT NULL COMMENT 'Cantcodad del insumo que se necesita para producir.',
  `cod_produccion` int DEFAULT NULL COMMENT 'Código de la producción a la que pertenen estos detalles.',
  PRIMARY KEY (`cod_detalle_produccion`),
  KEY `DetalleProduccion_CodProduccion_codx` (`cod_produccion`),
  KEY `DetalleProduccion_CodProducto_codx` (`cod_producto`),
...
CREATE TABLE `tbl_factura` (
  ...
  `descuento` decimal(10,2) DEFAULT NULL COMMENT 'Cantcodad del descuento.',
  `cai` varchar(100) DEFAULT NULL COMMENT 'Número CAI.',
  PRIMARY KEY (`cod_factura`),
  KEY `TBL_CLIENTE_COD_CLIENTE_codx` (`cod_cliente`),
...
CREATE TABLE `tbl_kardex` (
  ...
  `cod_tipo_movimiento` int DEFAULT NULL COMMENT 'Código del tipo de movimiento. Será de Entrada o Salcoda.',
  `fecha` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha del movimiento.',
  `cantcodad` int DEFAULT NULL COMMENT 'Cantcodad del producto o insumo que se ha tencodo un movimiento.',
  PRIMARY KEY (`cod_kardex`),
  KEY `tbl_Producto_Cod_Producto_codx` (`cod_producto`),
  KEY `Kardex_codTipoMovimiento_codx` (`cod_tipo_movimiento`),
...
) ENGINE=InnoDB AUTO_INCREMENT=154 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla que mostrará los movimientos de los productos. Ya sean de entrada o salcoda.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_ms_bitacora` (
  ...
  KEY `bitacora_objeto_codx` (`cod_objeto`),
  KEY `bitacora_usuario_codx` (`cod_usuario`),
...
) ENGINE=InnoDB AUTO_INCREMENT=938 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla que almacena todos los eventos que se generen dentro del sistema.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_ms_hist_contrasena` (
  ...
  CONSTRAINT `histContra_codUsuario` FOREIGN KEY (`cod_usuario`) REFERENCES `tbl_ms_usuarios` (`cod_usuario`)
...
INSERT INTO `tbl_ms_parametros` VALUES (1,'ADMIN_INTENTOS','3',NULL,NULL,NULL,NULL),(2,'ADMIN_PREGUNTAS','2',NULL,NULL,NULL,NULL),(3,'ADMIN_CORREO','uniformesdelatlantico@hotmail.com',NULL,NULL,NULL,NULL),(4,'FECHA_VENCIMIENTO','30',NULL,NULL,NULL,NULL),(5,'IMPUESTO','15',NULL,NULL,'ADMIN','2023-04-16 02:57:05'),(6,'NOMBRE_EMPRESA','INVERSIONES UNIFORMES DEL ATLÁNTICO',NULL,NULL,'ADMIN','2023-04-18 10:35:48'),(7,'RAZON_SOCIAL','S. DE R. L. DE C. V.',NULL,NULL,NULL,NULL),(8,'TELEFONO_EMPRESA','9970-5887',NULL,NULL,NULL,NULL),(9,'DIRECCION','BO. EL CENTRO, DOMICILIO RENTADO, ATRÁS DE LA DESPENSA FAMILIAR, TELA. ATLÁNTcodA',NULL,NULL,NULL,NULL),(10,'RTN','01079021315692',NULL,NULL,NULL,NULL);
...
CREATE TABLE `tbl_ms_permisos` (
  `codpermiso` bigint NOT NULL AUTO_INCREMENT COMMENT 'cod del permiso.',
...
CREATE TABLE `tbl_ms_preguntas_usuario` (
  ...
  KEY `preguntaUsuario_codUsuario_codx` (`cod_usuario`),
  CONSTRAINT `preguntaUsuario_codUsuario` FOREIGN KEY (`cod_usuario`) REFERENCES `tbl_ms_usuarios` (`cod_usuario`)
...
CREATE TABLE `tbl_produccion` (
  ...
  `cod_producto` int DEFAULT NULL,
  `cantcodad` int DEFAULT NULL COMMENT 'Cantcodad que se va a producir.',
  ...
  KEY `Produccion_CodProducto_codx` (`cod_producto`),
  KEY `Produccion_codUsuario_codx` (`cod_usuario`),
  CONSTRAINT `Produccion_CodProducto` FOREIGN KEY (`cod_producto`) REFERENCES `tbl_producto` (`cod_producto`),
  CONSTRAINT `Produccion_codUsuario` FOREIGN KEY (`cod_usuario`) REFERENCES `tbl_ms_usuarios` (`cod_usuario`)
...
CREATE TABLE `tbl_producto` (
  ...
  `cantcodad_minima` int DEFAULT NULL COMMENT 'Cantcodad mínima que se debe tener de ese producto en el inventario.',
  `cantcodad_maxima` int DEFAULT NULL COMMENT 'Cantcodad máxima que se debe tener de ese producto en el inventario.',
  ...
  KEY `TBL_TIPO_PRODUCTO_COD_TIPO_PRODUCTO_codx` (`cod_tipo_producto`),
...
CREATE TABLE `tbl_promocion` (
  ...
  KEY `Promo_Usuario_codx` (`cod_usuario`),
...
CREATE TABLE `tbl_promocion_producto` (
  ...
  `cod_producto` int DEFAULT NULL COMMENT 'Código del producto.',
  `cantcodad` int DEFAULT NULL COMMENT 'Cantcodad de producto.',
  PRIMARY KEY (`cod_promocion_producto`),
  KEY `promocion_producto_codx` (`cod_promocion`),
  KEY `promocionProducto_Producto_codx` (`cod_producto`),
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Taba que almacena los dos tipos de movimientos. Entrada y Salcoda.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_tipo_movimiento` VALUES (1,'ENTRADA'),(2,'SALcodA');
...
-- Dump completed on 2023-06-05  8:07:40
