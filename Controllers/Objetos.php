	...
	public function getObjetos()
	{
		if ($_SESSION['permisosMod']['r']) {
			...
			for ($i = 0; $i < count($arrData); $i++) {
				...
				if ($_SESSION['permisosMod']['u']) {
					$btnEdit = '<button class="btn btn-primary  btn-sm btnEditUsuario" onClick="fntEditPregunta(this,' . $arrData[$i]['id_objeto'] . ')" title="Editar usuario"><i class="fas fa-pencil-alt"></i></button>';
				} else {
					$btnEdit = '<button class="btn btn-secondary btn-sm" disabled ><i class="fas fa-pencil-alt"></i></button>';
				}
				
				if ($_SESSION['permisosMod']['d']) {
					$btnDelete = '<button class="btn btn-danger btn-sm btnDelUsuario" onClick="fntDelPregunta(' . $arrData[$i]['id_objeto'] . ')" title="Eliminar usuario"><i class="far fa-trash-alt"></i></button>';
				} else {
